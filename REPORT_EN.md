...
These results show that the generated testbenches identify a single candidate implementation for all 10 visible problems.
...
The hardest family during development was `cdc_fifo_flops_push_credit`, but the final version also isolates a single visible mutant for that case.
